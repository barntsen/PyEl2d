...
\begin{eqnarray}
  \sigma_{xx}(\xx, t) & = & \sigma_{xx}( x+\Delta x/2, y,z, t), \nonumber\\
  \sigma_{yy}(\xx, t) & = & \sigma_{yy}(x, y+\Delta y/2, t), \nonumber\\
\end{eqnarray}
%\begin{eqnarray}
%  \gamma_{\lambda}(\xx, t) & = & \gamma_{\lambda}(x, y,  z, t), \\ 
%  \gamma_{\mu}(\xx, t) & = & \gamma_{\mu}(x, y, z, t),          \\ 
...
are defines on the grid:
%
\begin{eqnarray}
  \sigma_{xy}(\xx, t) & = & \sigma_{xy}(x +\Delta x/2, t) 
                                        \nonumber\\
\end{eqnarray}
%\begin{eqnarray}
%  \gamma_{xy}(\xx, t) & = & \gamma_{xy}(x +\Delta x/2, y 
...
%
\begin{eqnarray}
   \lambda_u(\xx) & = & \lambda_u(x+\Delta x/2,y),\\
   \mu_u(\xx)     & = & \mu_u(x,y+\Delta x/2).
\end{eqnarray}
