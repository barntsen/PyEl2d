...
{
struct model* m;
int nctemp1888 = (Rheol ==2);
if(nctemp1888)
{
nctempfloat2* nctemp1896= vp;
nctempfloat2* nctemp1899= vs;
nctempfloat2* nctemp1902= rho;
nctempfloat2* nctemp1905= Qlx;
nctempfloat2* nctemp1908= Qly;
nctempfloat2* nctemp1911= Qmx;
nctempfloat2* nctemp1914= Qmy;
nctempfloat2* nctemp1917= Qpx;
nctempfloat2* nctemp1920= Qpy;
float nctemp1923= Dx;
float nctemp1925= Dt;
float nctemp1927= W0;
int nctemp1929= Nb;
struct model* nctemp1931=Modelsls(nctemp1896,nctemp1899,nctemp1902,nctemp1905,nctemp1908,nctemp1911,nctemp1914,nctemp1917,nctemp1920,nctemp1923,nctemp1925,nctemp1927,nctemp1929);
m =nctemp1931;
}
else{
int nctemp1933= 4;
struct nctempchar1 *nctemp1937;
static struct nctempchar1 nctemp1938 = {{ 18}, (char*)"Unknown Q-model\n\0"};
nctemp1937=&nctemp1938;
nctempchar1* nctemp1935= nctemp1937;
int nctemp1939=LibePuts(nctemp1933,nctemp1935);
int nctemp1941= 4;
int nctemp1943=LibeFlush(nctemp1941);
int nctemp1945=LibeExit();
}
return m;
}
float ModelStability (struct model* Model)
...
{
int nctemp1982=i;
nctemp1982=j*Model->Lambda->d[0]+nctemp1982;
int nctemp1990=i;
nctemp1990=j*Model->Mu->d[0]+nctemp1990;
float nctemp1993 = 2.0 * Model->Mu->a[nctemp1990];
float nctemp1994 = Model->Lambda->a[nctemp1982] + nctemp1993;
int nctemp1996=i;
nctemp1996=j*Model->Rho->d[0]+nctemp1996;
float nctemp1999 = nctemp1994 / Model->Rho->a[nctemp1996];
float nctemp1975= nctemp1999;
float nctemp2000=LibeSqrt(nctemp1975);
vp =nctemp2000;
float nctemp2012 = vp * Model->Dt;
float nctemp2014 = nctemp2012 / Model->Dx;
stab =nctemp2014;
float nctemp2023= 2.0;
float nctemp2025=LibeSqrt(nctemp2023);
float nctemp2026 = 1.0 / nctemp2025;
int nctemp2015 = (stab > nctemp2026);
if(nctemp2015)
{
int nctemp2028= 4;
struct nctempchar1 *nctemp2032;
static struct nctempchar1 nctemp2033 = {{ 28}, (char*)"Stability index too large! \0"};
nctemp2032=&nctemp2033;
nctempchar1* nctemp2030= nctemp2032;
int nctemp2034=LibePuts(nctemp2028,nctemp2030);
int nctemp2036= 4;
float nctemp2038= stab;
struct nctempchar1 *nctemp2042;
static struct nctempchar1 nctemp2043 = {{ 2}, (char*)"g\0"};
nctemp2042=&nctemp2043;
nctempchar1* nctemp2040= nctemp2042;
int nctemp2044=LibePutf(nctemp2036,nctemp2038,nctemp2040);
int nctemp2046= 4;
struct nctempchar1 *nctemp2050;
static struct nctempchar1 nctemp2051 = {{ 3}, (char*)"\n\0"};
nctemp2050=&nctemp2051;
nctempchar1* nctemp2048= nctemp2050;
int nctemp2052=LibePuts(nctemp2046,nctemp2048);
int nctemp2054= 4;
struct nctempchar1 *nctemp2058;
static struct nctempchar1 nctemp2059 = {{ 7}, (char*)"vp: \n\0"};
nctemp2058=&nctemp2059;
nctempchar1* nctemp2056= nctemp2058;
int nctemp2060=LibePuts(nctemp2054,nctemp2056);
int nctemp2062= 4;
float nctemp2064= vp;
struct nctempchar1 *nctemp2068;
static struct nctempchar1 nctemp2069 = {{ 2}, (char*)"g\0"};
nctemp2068=&nctemp2069;
nctempchar1* nctemp2066= nctemp2068;
int nctemp2070=LibePutf(nctemp2062,nctemp2064,nctemp2066);
int nctemp2072= 4;
struct nctempchar1 *nctemp2076;
static struct nctempchar1 nctemp2077 = {{ 3}, (char*)"\n\0"};
nctemp2076=&nctemp2077;
nctempchar1* nctemp2074= nctemp2076;
int nctemp2078=LibePuts(nctemp2072,nctemp2074);
int nctemp2080= 4;
struct nctempchar1 *nctemp2084;
static struct nctempchar1 nctemp2085 = {{ 7}, (char*)"dt: \n\0"};
nctemp2084=&nctemp2085;
nctempchar1* nctemp2082= nctemp2084;
int nctemp2086=LibePuts(nctemp2080,nctemp2082);
int nctemp2088= 4;
float nctemp2090= Model->Dt;
struct nctempchar1 *nctemp2094;
static struct nctempchar1 nctemp2095 = {{ 2}, (char*)"g\0"};
nctemp2094=&nctemp2095;
nctempchar1* nctemp2092= nctemp2094;
int nctemp2096=LibePutf(nctemp2088,nctemp2090,nctemp2092);
int nctemp2098= 4;
struct nctempchar1 *nctemp2102;
static struct nctempchar1 nctemp2103 = {{ 3}, (char*)"\n\0"};
nctemp2102=&nctemp2103;
nctempchar1* nctemp2100= nctemp2102;
int nctemp2104=LibePuts(nctemp2098,nctemp2100);
int nctemp2106= 4;
struct nctempchar1 *nctemp2110;
static struct nctempchar1 nctemp2111 = {{ 7}, (char*)"dx: \n\0"};
nctemp2110=&nctemp2111;
nctempchar1* nctemp2108= nctemp2110;
int nctemp2112=LibePuts(nctemp2106,nctemp2108);
int nctemp2114= 4;
float nctemp2116= Model->Dx;
struct nctempchar1 *nctemp2120;
static struct nctempchar1 nctemp2121 = {{ 2}, (char*)"g\0"};
nctemp2120=&nctemp2121;
nctempchar1* nctemp2118= nctemp2120;
int nctemp2122=LibePutf(nctemp2114,nctemp2116,nctemp2118);
int nctemp2124= 4;
struct nctempchar1 *nctemp2128;
static struct nctempchar1 nctemp2129 = {{ 3}, (char*)"\n\0"};
nctemp2128=&nctemp2129;
nctempchar1* nctemp2126= nctemp2128;
int nctemp2130=LibePuts(nctemp2124,nctemp2126);
int nctemp2132= 4;
int nctemp2134=LibeFlush(nctemp2132);
}
}
int nctemp2143 = i + 1;
i =nctemp2143;
int nctemp2144 = (i < nx);
nctemp1967=nctemp2144;
}
}
int nctemp2156 = j + 1;
j =nctemp2156;
int nctemp2157 = (j < ny);
nctemp1959=nctemp2157;
}
return stab;
}
}
